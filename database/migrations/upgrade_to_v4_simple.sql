-- ============================================
-- HotelOS v4.0 Migration (Shared Hosting Compatible)
...
-- ============================================
ALTER TABLE `users` ADD COLUMN `pin` CHAR(4) NULL COMMENT '4-digit PIN for staff quick login' AFTER `locked_until`;

-- ============================================
-- 2. ADD ledger_type COLUMN TO transactions TABLE
-- ============================================
ALTER TABLE `transactions` ADD COLUMN `ledger_type` ENUM('cash_drawer', 'bank', 'ota_receivable', 'credit_ledger') DEFAULT 'cash_drawer' COMMENT 'Which ledger this transaction affects' AFTER `category`;
...
-- ============================================
-- 4. CREATE room_move_history TABLE
-- ============================================
...
-- ============================================
-- 8. CREATE subscription_transactions TABLE
-- ============================================
...
-- ============================================
-- 9. CREATE invoice_snapshots TABLE
-- ============================================
...
-- ============================================
-- 10. SEED subscription_plans (if empty)
-- ============================================
...
SELECT 'Migration Complete! v4.0' AS Status;
